...
<section id="content">
	 ...
	 <main>
			...
			<div class="row">
					...
					<div class="card">
						<div class="card-body">
							<div class="d-flex flex-column align-items-center text-center">
								<img id="photoDemo" src="${ctp}/member/${vo.photo}" alt="member" class="rounded-circle p-1 bg-primary" width="110" >
								
								<div class="mt-3">
									<label for="file" class="photolabel"><span class="badge">변경</span></label>
									
									<form name="photoForm" method="post" action="${ctp}/member/memberPhotoChange" enctype="multipart/form-data">
				...
				<div class="col-lg-8">
					<div class="btng" style="margin-bottom:10px">
						<span style="font-size:35px; margin-top:-10px" ><a href="${ctp}/member/memberMessage" ><i class="bi bi-envelope"></i></a></span>
						<span>
							<button class="btn btn-success"  data-toggle="modal" data-target="#myModal">문의하기</button>
							<button class="btn btn-info" onclick="userDelete()">탈퇴</button>
						</span>
					</div>
					<div class="card">
						
						<div class="card-body">
							<form name="editForm" method="post" action="${ctp}/member/memberEdit">
							<div class="row mb-3">
								<div class="col-sm-3">
									<h6 class="mb-0">성</h6>
								</div>
...
<div class="modal fade" id="myModal"  >
   <div class="modal-dialog modal-dialog-centered">
     <div class="modal-content"  >
       ...
       <form name="messageForm" method="post" action="${ctp}/member/memberMessage">
       	<div class="msgContainer">
		    <label for="from">From</label>
		    <input type="text" id="from" name="fromMid" value="${vo.mid}" readonly>
		
		    <label for="to">TO</label>
		    <input type="text" id="to" name="toMid" value="admin" readonly>
